...
@NamedQueries({
        ...
        @NamedQuery(name = "Sessao.findByNomeFilme", query = "SELECT s FROM Sessao s INNER JOIN s.idFilme f WHERE f.nome = :nome"),
...
public class Sessao implements Serializable {
    ...
    public String toString() {
        return "Sala: [" + getSala() + "] Lingua: [" + getLinguagem() + "] Horario: [" + getHorarioInicio() + "]";
    }
