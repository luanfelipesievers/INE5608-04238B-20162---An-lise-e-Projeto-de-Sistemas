...
@NamedQueries({
        ...
        @NamedQuery(name = "Reserva.findByCpfAndCodigo", query = "SELECT r FROM Reserva r INNER JOIN r.idCliente c WHERE r.codigoReserva = :codigoReserva AND c.cpf = :cpf AND r.retirado=false "),
...
public class Reserva implements Serializable {
    ...
    public String toString() {
        return "br.com.moviecomander.cliente.entity.Reserva[ id=" + id + " ]";
    }
